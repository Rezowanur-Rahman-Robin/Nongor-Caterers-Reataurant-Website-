...
if(isset($_GET['delete_id'])){
  ...
  $do_delete_id= "delete from food_menu where food_menu_id='$delete_id'";
    ...
    <div class="main-panel">
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top " id="navigation-example">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:void(0)">Menu List</a>
          </div>
      ...
      <div class="content">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-md-12">
            <a href="create.php?type=menus" class="btn btn-info float-right mb-2 mr-3"><span class="material-icons mr-1" style=" font-size: 24px;">add_circle</span>Create New Menu</a>
            </div>
            <div class="col-md-12">
            
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title text-center font-weight-bold">Food Menu</h4>
                  <p class="card-category text-center"> Here's all the list of food menus.</p>
                </div>
                <div class="card-body">
...
?>
                        <tr>
                          ...
                          <td>
                            <a href="edit.php?type=menus&&menu_id=<?php echo $menu_id ;?>">  <span class="material-icons text-success">border_color</span></a>
                          </td>
                          <td class="text-primary">
                            <a href="menus.php?delete_id=<?php echo $menu_id ?>">  <span class="material-icons text-danger">clear</span>  </a>
