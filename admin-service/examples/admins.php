...
if(isset($_GET['delete_id'])){
  ...
  $do_delete_id= "delete from admins where admin_id='$delete_id'";
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top " id="navigation-example">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:void(0)">Admins</a>
          </div>
          ...
          <div class="col-md-12">
            ...
            <div class="card">
              <div class="card-header card-header-primary">
                <h4 class="card-title text-center font-weight-bold">Admin List</h4>
                <p class="card-category text-center"> Here's all the list of admins.</p>
              </div>
              <div class="card-body">
...
while($row_admins = mysqli_fetch_array($run_admins)){
     ...
     $admin_phn = $row_admins['admin_phn'];
...
?>
                      ...
                      <tr>
                        ...
                        <td>
                        <a href="admins.php?delete_id=<?php echo $admin_id; ?> ">  <span class="material-icons text-danger">clear</span>  </a>
                        </td>
