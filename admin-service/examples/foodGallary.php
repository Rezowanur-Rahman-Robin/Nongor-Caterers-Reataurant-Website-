            ...
            <div class="col-md-12">
              ...
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title text-center font-weight-bold">Food Gallary</h4>
                  <p class="card-category text-center"> Here's all the list of food gallary.</p>
                </div>
                <div class="card-body">
...
?> 
                        ...
                        <tr>
                          ...
                          <td class="text-primary">
                            <a href="foodGallary.php?delete_id=<?php echo $item_id ?>">  <span class="material-icons text-danger">clear</span>  </a>
