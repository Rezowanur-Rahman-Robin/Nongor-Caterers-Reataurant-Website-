...
if(isset($_GET['delete_id'])){
  ...
  $do_delete_id= "delete from services where service_id='$delete_id'";
  ...
  <div class="wrapper ">
    ...
    <div class="main-panel">
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top " id="navigation-example">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:void(0)">Services</a>
          </div>
      ...
      <div class="content">
        <div class="row">
        <div class="col-md-12">
            <a href="create.php?type=services" class="btn btn-info float-right mb-2 mr-5"> <span class="material-icons mr-1" style=" font-size: 24px;">add_circle</span>Create New Categories</a>
            </div>
        </div>
        ...
        <div class="container-fluid">
          <div class="card">
            <div class="card-header card-header-primary">
              <h4 class="card-title text-center font-weight-bold">Services</h4>
              <p class="card-category text-center">All of your services
              </p>
            </div>
            <div class="card-body">
              <div class="row">
...
?>
                ...
                <div class="col-md-6">
                  ...
                  <div class="alert alert-warning row-eq-height">
                    <div class="container-fluid pb-4">
                    <div class="row">
                      <div class="col-sm-11">
                      <p class="float-left font-weight-bold"> <?php echo $service_desc; ?> </p>

                      </div>

                      <div class="col-sm-1">
                      <a href="services.php?delete_id=<?php echo $service_id ;?>" class="float-right">  <span class="material-icons text-danger">clear</span>  </a>
...
<!-- Mirrored from demos.creative-tim.com/material-dashboard-dark/examples/services.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 13 Mar 2021 07:08:54 GMT -->
</html>
