...
if(isset($_GET['delete_id'])){
  ...
  if($run_update){
      ...
      echo "<script>window.open('restaurantGallary.php','_self')</script>";
            ...
            <div class="col-md-12">
              ...
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title text-center font-weight-bold">Restaurant Gallary</h4>
                  <p class="card-category text-center"> Here's all the list of restaurant gallary.</p>
                </div>
                <div class="card-body">
...
$get_items = "select * from food_item where item_gallary_type='Restaurant'";
...
?> 
                        ...
                        <tr>
                          ...
                          <a href="restaurantGallary.php?delete_id=<?php echo $item_id ?>">  <span class="material-icons text-danger">clear</span>  </a>
