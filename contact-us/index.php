...
<!-- Mirrored from bonjourbd.com/contact-us/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 12 Mar 2021 05:39:00 GMT -->
...
<link rel='shortlink' href='../index5831.php?p=19' />
<link rel="alternate" type="application/json+oembed" href="../wp-json/oembed/1.0/embed6662.json?url=https%3A%2F%2Fbonjourbd.com%2Fcontact-us%2F" />
<link rel="alternate" type="text/xml+oembed" href="../wp-json/oembed/1.0/embed8e25?url=https%3A%2F%2Fbonjourbd.com%2Fcontact-us%2F&amp;format=xml" />
</head>
...
<li id="menu-item-25" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-19 current_page_item menu-item-25"><a href="index.php" aria-current="page">Contact Us</a></li>
...
?>
                    ...
                    <div class="row"> 
                        <div class="col-md-9 lec_animation_block lec_map_hidden_top" data-bottom-top="transform:translate3d(0px, 40px, 0px)" data-top-bottom="transform:translate3d(0px, -40px, 0px)">
                           <div class="lec_map_container">
                                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3689.8123643484487!2d91.81918141449384!3d22.360712685292185!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x30acd88ff296fcf1%3A0xedc259666c2422db!2sBonjour!5e0!3m2!1sen!2sbd!4v1575463678143!5m2!1sen!2sbd" height="680" scrolling="no"></iframe>
                            </div>
                        </div>

                        <div class="col-md-5 lec_animation_block lec_animation_abs_block lec_posr lec_image_bck" data-bottom-top="transform:translate3d(0px, 0px, 0px)" data-top-bottom="transform:translate3d(0px, 40px, 0px)" data-image="images/main_back.jpg">

                            <!-- Over -->
                            <div class="lec_over" data-color="#fff" data-opacity="1"></div>

                            <div class="lec_parallax_menu lec_image_bck lec_fixed">
                                <h2 class="heading-item2 lec_title_counter">Contact</h2>
                                <h3 class="lec_gold_subtitle">Please Contact for Details</h3>
                                <p>A Place where you can spend quality time along with enjoying the delicious world famous cuisines.</p>

                                <h3>Contact Info</h3>

                                <div class="row lec_contacts_icons">
                                    <i class="ti ti-location-pin"></i> CJKS stadium shooping complex,4 th floor shop no 5009 <br> Nur ahmed chowdhury road kazir Dewory Kotowali,Chattogram.<br>
                                    <i class="ti ti-email"></i> nongorceterers@gmail.com  <br>
									<i class="ti ti-mobile"></i> +01844668812-14 <br>
                                    <i class="ti ti-link"></i> www.nongorceterers.com <br>
                                </div>
                            </div>
                        </div>
    ...
    <footer class="lec_image_bck text-center lec_wht_txt" data-image="../wp-content/themes/Bonjour/images/main_back_bl.jpg">
        <div class="container">
            ...
            <h4><p>© Bonjour 2019 | Web Design & Development By: <a href="http://rezowanurrahmanrobin.epizy.com/" target="_blank">RobTechBD Limited</a> </p>
            </h4>
        </div>
    </footer>
    <!-- Footer End -->
...
<!-- Mirrored from bonjourbd.com/contact-us/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 12 Mar 2021 05:39:01 GMT -->
</html>
<!-- Page generated by LiteSpeed Cache 2.9.9.2 on 2021-03-09 12:52:53 -->