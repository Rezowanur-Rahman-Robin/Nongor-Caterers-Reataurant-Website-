...
<li id="menu-item-89" class="menu-item  menu-item-type-taxonomy food-menu  menu-item-object-category current-menu-item menu-item-has-children menu-item-89"><a href="index.php" aria-current="page">Food Menu</a>
<ul class="sub-menu">
<?php
...
?>
    ...
    <section id="lec_content" class="lec_content">
        ...
        <section class="lec_section">
              <div class="container">
                <div class="row">
                   <div class="col-md-12 text-center"> <h2 class="heading-item2  "> Food Menu</h2></div>
                    <?php 
                    ...
                    <div class="col-md-4">
                     ...
                     <a href="index2.php?menu=<?php echo $menu_id ?>">
    ...
    color: white;
}">  <?php echo $menu_title; ?> <span class="material-icons" style="    float: right;">
arrow_right_alt
</span> </div>
  </a>
...
while($row_categories = mysqli_fetch_array($run_categories)){
     ...
     $get_count_item = "select * from food_item where item_cat=$cat_id && item_menu=$menu_id";
...
?>
                              <table class="table table-bordered">
                                  <thead>
                                    <tr class="success">
                                      <th colspan="2" class="text-center">  <?php echo $cat_title; ?></th>
                                    </tr>
                                    <tr>
                                      <th>Menu Name</th>
                                      <th>Price</th>
...
$get_items = "select * from food_item where item_menu=$menu_id && item_cat=$cat_id";
